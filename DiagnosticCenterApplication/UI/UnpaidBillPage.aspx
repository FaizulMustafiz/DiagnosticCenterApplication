<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnpaidBillPage.aspx.cs" Inherits="DiagnosticCenterApplication.UI.UnpaidBillPage" %>
<%@ Import Namespace="DiagnosticCenterApplication.Models" %>
...
<body>
        ...
        <div class="row">
            <div class="col-lg-10" style="margin-left: 150px">
                <form id="testWiseReportForm" runat="server" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <asp:Label ID="messageLable" runat="server" Text="" class="text-danger"></asp:Label>
                        <br />
                        <br />
                        <div class="col-sm-offset-2 col-sm-10">
                            <asp:Button ID="unpaidBillSearchButton" runat="server" Text="Show" CssClass="btn btn-success" OnClick="unpaidBillSearchButton_Click" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <asp:GridView ID="unpaidBillGridView" runat="server" CssClass="table" HorizontalAlign="Center" AutoGenerateColumns="False" EmptyDataText="No Records For Input Date" OnRowDataBound="unpaidBillGridView_RowDataBound" ShowFooter="True">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Due Amount" Visible="False">
                                    <ItemTemplate>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <asp:Button ID="unpaidBillPdfButton" runat="server" Text="Pdf" CssClass="btn btn-primary" OnClick="unpaidBillPdfButton_Click" />
                        </div>
                    </div>
                    <br />
                    <br />
    ...
    <script>
        $(document).ready(function () {
            ...
            var rowCount = $('#unpaidBillGridView tr').length;

            if (rowCount > 1) {
                rows = $("#unpaidBillGridView").children("tbody").children("tr");
